...
public class OptionsConverter {
    ...
    public OptionsConverter(Options options) {
        this.options = options;
    }

    public String getOptionsFtl() {
        log.info("Setting & preparing options ftl Data");
        TemplateManager templateManager = new TemplateManager();
        Map<String, Object> templateData = new HashMap<>();
        templateData.put("options", options);
        String templateStr = templateManager.processTemplate("options", templateData);
        log.info("Completed Setting & preparing options ftl Data");
        return templateStr;
    }
}
