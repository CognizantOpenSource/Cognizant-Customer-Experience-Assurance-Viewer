...
public class UserService {
    ...
    public User assertOrGet(String userId){
    ...
    public Optional<User> getUserByEmailIgnoreCase(String email) {
        log.info("Getting User based on the email IgnoreCase. EmailId is : " + email);
...
//        log.info("Updating the User data: " + user.toString());
    ...
    public User signUpUser(UserDTO userDTO) {
        if (!getUserByEmailIgnoreCase(userDTO.getEmail()).isPresent()) {
