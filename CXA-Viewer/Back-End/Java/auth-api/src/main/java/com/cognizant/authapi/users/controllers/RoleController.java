...
public class RoleController {
     ...
     */
    @GetMapping(value = "")
    @PreAuthorize("hasPermission('Role','cxa.role.read')")
    ...
    @PostMapping(value = "")
    @PreAuthorize("hasPermission('Role','cxa.role.create')")
    ...
    @Transactional
    @PreAuthorize("hasPermission('Role','cxa.role.update')")
    ...
    @PreAuthorize("hasPermission('Role','cxa.role.delete')")
