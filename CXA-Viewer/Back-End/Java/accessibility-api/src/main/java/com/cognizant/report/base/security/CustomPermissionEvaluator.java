...
package com.cognizant.report.base.security;
...
public class CustomPermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasPermission(Authentication auth, Object targetDomainObject, Object permission) {
        ...
        return hasPrivilege((UserPrincipal) auth.getPrincipal(), targetType, permission.toString());
    }
    ...
    private boolean hasPrivilege(UserPrincipal auth, String targetType, String permission) {
